...
**Query Parameters:** page, limit, status, sortMethod
...
**Description:** Upload new version of existing material.
...
| userId | string | No | MongoDB ObjectId (defaults to requester) |
...
```json
{
  "message": "آمار ثبت نام دوره با موفقیت بازیابی شد.",
  "data": {
    "active": 30,
    "completed": 10,
    "dropped": 5,
